...
function Header() {
  ...
  <div className='header-wrap'>
    <div className="header-2">
      ...
      <nav className="bg-[#00203f] py-2 md:py-4">
        <div className="container px-4 mx-auto md:flex md:items-center">
          ...
          <div className="hidden md:flex flex-col md:flex-row md:ml-auto mt-3 md:mt-0" id="navbar-collapse">
            ...
            <Link to="/work" className="p-2 lg:px-4 md:mx-2 text-gray-600 rounded hover:bg-gray-200 hover:text-gray-700 transition-colors duration-300">About</Link>
            <Link to="/contact" className="p-2 lg:px-4 md:mx-2 text-indigo-600 text-center border border-solid border-indigo-600 rounded hover:bg-indigo-600 hover:text-white transition-colors duration-300 mt-1 md:mt-0 md:ml-1">Get In Touch</Link>
          </div>
        </div>
      </nav>
